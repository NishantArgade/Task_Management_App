<x-app-layout>
    ...
    <div class="container mx-auto flex justify-center  mt-4 ">
        ...
        <form class="w-1/2" method="post" action="{{ route('task.store') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input class="shadow dark:border placeholder-gray-400 dark:placeholder-gray-300  dark:bg-gray-500 bg-gray-50 border-0  appearance-none rounded w-full py-2 px-3 dark:text-gray-200  text-gray-500 leading-tight focus:outline-none focus:shadow-outline" name="title" type="text" placeholder="Title">
            </div>
            <div class="mb-4">
                <label class="block text-gray-500 text-sm font-bold mb-2" for="description">
                    Description
                </label>
                <textarea class="shadow h-28 placeholder-gray-400 dark:placeholder-gray-300  resize-none dark:border  dark:bg-gray-500 bg-gray-50 border-0   appearance-none  rounded w-full py-2 px-3  dark:text-gray-200  text-gray-500 leading-tight focus:outline-none focus:shadow-outline" name="description" placeholder="Description"></textarea>
            </div>
            <div class="mb-4">
                <label class="block text-gray-500 text-sm font-bold mb-2" for="due_date">
                    Due Date
                </label>
                <input class="shadow dark:border placeholder-gray-400 dark:placeholder-gray-300   dark:bg-gray-500 bg-gray-50 border-0  appearance-none  rounded w-full py-2 px-3  dark:text-gray-200  text-gray-500 leading-tight focus:outline-none focus:shadow-outline" name="due_date" type="date">
            </div>
            <div class="mb-4">
                            ...
                            <div class=" bg-gray-300 rounded-md shadow-xs ">
                                <div class="flex flex-col max-h-60 overflow-y-auto">
                                    ...
                                    <label class="px-4 py-2 flex items-center justify-start gap-x-2 cursor-pointer dark:bg-gray-400 bg-gray-50 dark:hover:bg-gray-300 hover:bg-gray-200">
                                        <input id="option1" type="checkbox" class="form-checkbox h-5 w-5 text-indigo-600 transition duration-150 ease-in-out" onchange="updateSelectedCount()">
                ...
                <div class="flex items-center gap-x-2 mt-6">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="submit">Submit</button>
